...
class SakuraBaseMainFrame( sakura_gui_autogenerated.MainFrame ):
    ...
    def OnCheckList_SpecSelect(self, event):
        ...
        # update reference to detector object
...
#         mu, chi = gmda.getAverage(self.goodPixels, self.det)
#         self.averageMu = mu
#         self.averageChi = chi
...
#         self.results[self.specSelec].averageChi = chi
    ...
    def OnLeftDownPixel(self, event):
        ...
        y = self.results[self.specSelec].det[index].chi * x**2
        xlabel = 'k  /  A^-1'
        ylabel = 'chi(k)*k^2  /  a.u.'
        moreY = self.results[self.specSelec].averageChi * x**2
    ...
    def OnClick_Load( self, event ):
        ...
        if dialog.ShowModal() == wx.ID_OK:
            ...
            try:
                ...
                # GR - I'm moving the Result() object creation here, because
                # initialProcessData() tries to write to the object to maintain the
                # averages
    ...
    def OnClick_Save( self, event ):
        ...
        try:
            ...
            for i in self.spectraChecked:
                ...
                gmda.writeAverages(self.results[i], reader_type)
