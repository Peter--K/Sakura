...
#         self.results[self.specSelec].averageChi = chi
    ...
    def OnClick_Load( self, event ):
        ...
        if dialog.ShowModal() == wx.ID_OK:
            ...
            # in the __init__ function of this Class MainFrame, we generated a list of
            #   'results' objects (empty there)
            # keep filling this list after the first processing round
            ...
            #   and Weight Factor radio box buttons to enable user choices and interaction
    ...
    def update_plot_displays(self) :
        ...
        xlabelchi , ylabelchi = 'k  /  A^-1', 'k^2 * chi(k)  /  a.u.'
    ...
    def reaverage(self):
        self.weights = gmda.getWeightFactors(
            ...
            self.m_radioBox1.GetStringSelection())
    ...
    def initialProcessData(self, whichFileToProcess):
        ...
        #   obtain "roiCorr"
        if self.detSize == 100 :
            self.ICRCorrParams = np.loadtxt(SAKURA_HOME_PATH+"\\100eleICRcorrect.ini")
