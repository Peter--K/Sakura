...
#     '''
    def OnPaint_SpectrumPlotCanvas(self, event):
#         print 'Paint',
        dc = wx.PaintDC(self)
#         self.DrawOverlay()      # refresh
        event.Skip()
        print 'SpectrumPlotCanvas',
#     '''
...
#             if not self.m_DetectorPanel.IsShown():
    ...
    def OnChanging_UpperNotebook(self, event):
        ...
        '''
        nb_page = self.m_UpperNotebook.GetSelection()
        if (nb_page == 0) and (self.reader != gnc):
            event.Veto()
